...
/**
 * Created by Sandon on 2019-05-07.
 */
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fileContent = Object.keys(option.sassVariables)
                        .map(function (key) {
                        return key + ": " + option.sassVariables[key] + ";";
                    })
                        .join('\n');
                    return [4 /*yield*/, writeFile(option.configFile, fileContent, 'utf8')
                        // build
                    ];
                case 1:
                    _a.sent();
